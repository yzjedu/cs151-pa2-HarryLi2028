...
| **-NO** | User inputs the number of sticks to start with |
...
- User does not input the number of sticks instead you select by using random function which was not the case. 
- 
### Grade: M
